...
{
    /**
     * Format the given resultset to given page
     *
     * @param r A SoapResultSet
     * @param page A HTMLPage
     * @throws Exception A serious problem occurs
     */
    public static void make(final SoapResultSet r, final HTMLPage page) throws Exception
    {
        ...
        {
            /**
             * Don't allow a single user to kill the system.
             */
            if( row > 1000)
            {
                HTMLText t = new HTMLText( "\n*** More than 1000 rows ***\n");
                t.setBold( true).setColor(Color.RED);
    ...
    private static final Log LOGGER = CLogger.getLog( "com.aspc.remote.jdbc.formatter.ResultSetFormatter");//#LOGGER-NOPMD
}
