...
import com.aspc.remote.util.misc.DiffMatchPatch;
import com.aspc.remote.util.misc.DiffMatchPatch.Diff;
import com.aspc.remote.util.misc.DiffMatchPatch.Patch;
import com.aspc.remote.util.misc.DiffMatchPatch.LinesToCharsResult;
...
public class TestDiffMatchPatch extends TestCase
{
    ...
    {
        Test test = suite();
        // test = TestSuite.createTest(TestStringUtilities.class, "testRandomPasswordNonsequential");
        TestRunner.run(test);
    ...
    {
        TestSuite suite = new TestSuite(TestDiffMatchPatch.class);
        return suite;
    }
    //  DIFF TEST FUNCTIONS
    ...
    public void testDiffMain()
    {
        ...
        assertTrue("diff_main: Timeout max.", (dmp.Diff_Timeout * 1000 * 2 + 60000) > endTime - startTime);
        dmp.Diff_Timeout = 0;
